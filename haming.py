...
def from_hamming_code(data, size_block):
    ...
    for i in range(m // full_size_block):
        ...
        correction = detectError(data_block, r)
        if (correction != 0):
...
if __name__ == "__main__":
    ...
    size_block_2 = size_block + calcRedundantBits(size_block)
